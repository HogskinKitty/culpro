    ...
    <div class="road-map">
        ...
        <div class="road-map-left">
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;">
                <div class="column" style="width:176px; min-height:190px;">
                    <div class="route"
                        style="background-color: #546ec5;color:#ffffff;height:30px;line-height:30px;font-size:12px;font-weight:700px;padding-left:24px;">
                        CULPRO 路书 1.0
                    </div>
                    <div class="category"
                        style="background-color: #7E93D5;color:#ffffff;height:30px;line-height:30px;font-size:12px;font-weight:700px;padding-left:24px;">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <span
                                style="color: #fff; display: flex; justify-content: center; align-items: center; width: 24px; height: 24px; padding-top: 1px; border-radius: 50%; background-color: #e1251b; transform: scale(.6);">A</span>核心
                            <span
                                style="color: #fff; display: flex; justify-content: center; align-items: center; width: 24px; height: 24px; padding-top: 1px; border-radius: 50%; background-color: #999999; transform: scale(.6);">B</span>辅助
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div css="row"
                ...
                <div class="left_right" style="position: relative;margin-top:-20px;margin-left:140px;">
                    <div class="left-corner"
                        style="margin: 100px auto; border-top-left-radius:60px; border-bottom-left-radius:60px; box-shadow: 0 0 0 30px #00ccff, 0 0 0 60px #99ffff; width: 40px;height:120px; clip-path: polygon(-300px 0px, 39px -220px, 39px 220px, 60px 220px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row"
                ...
                <div class="left_right" style="position: relative;margin-top:-40px;margin-left:140px;">
                    <div class="left-corner"
                        style="margin: 100px auto; border-top-left-radius:60px; border-bottom-left-radius:60px; box-shadow: 0 0 0 30px #00cccc, 0 0 0 60px #33ffcc; width: 40px;height:120px; clip-path: polygon(-300px 0px, 39px -220px, 39px 220px, 60px 260px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row"
                ...
                <div class="left_right" style="position: relative;margin-top:-40px;margin-left:140px;">
                    <div class="left-corner"
                        style="margin: 100px auto; border-top-left-radius:60px; border-bottom-left-radius:60px; box-shadow: 0 0 0 30px #DA70D6, 0 0 0 60px #FFBBFF; width: 40px;height:104px; clip-path: polygon(-300px 0px, 39px -220px, 39px 220px, 60px 260px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row"
                ...
                <div class="left_right" style="position: relative;margin-top:-40px;margin-left:140px;">
                    <div class="left-corner"
                        style="margin: 100px auto; border-top-left-radius:60px; border-bottom-left-radius:60px; box-shadow: 0 0 0 30px #FFD700, 0 0 0 60px #FFF68F; width: 40px;height:104px; clip-path: polygon(-300px 0px, 39px -220px, 39px 220px, 60px 260px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            <div css="row"
                style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:26px;margin-top:106px;">
        ...
        <!-- 地图中间 -->
        <div class="road-map-center">
            <div css="row" style="justify-content: flex-start;font-size: 12px;display: flex;">
                <div class="column" style="width:160px; min-height:164px;">
                    <div class="route"
        ...
        <div class="road-map-right">
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-40px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:146px; box-shadow: 0 0 0 30px #FFA07A, 0 0 0 60px #FF7F00; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-140px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:104px; box-shadow: 0 0 0 30px #99ff99, 0 0 0 60px #00cc99; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-140px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:120px; box-shadow: 0 0 0 30px #33ffcc, 0 0 0 60px #00cccc; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-140px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:104px; box-shadow: 0 0 0 30px #FFBBFF, 0 0 0 60px #DA70D6; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-140px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:172px; box-shadow: 0 0 0 30px #FFAEB9, 0 0 0 60px #FF3E96; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
            <!-- 空白占位 -->
            ...
            <div css="row" style="justify-content:flex-start;font-size: 12px;display: flex;margin-left:-1px;">
                <div class="row_right" style="right: 1px;margin-top:-140px;">
                    <div class="right-corner"
                        style="margin: 100px auto; border-top-right-radius:60px; border-bottom-right-radius:60px; width: 40px;height:146px; box-shadow: 0 0 0 30px #66ff99, 0 0 0 60px #33cc99; clip-path: polygon(1px -120px, 220px 0px, 160px 220px, 1px 300px);">
                    </div>
                </div>
            </div>
        </div>
